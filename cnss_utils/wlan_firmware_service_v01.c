...
static struct qmi_elem_info mlo_chip_type_info_s_v01_ei[] = {
	{
		.data_type      = QMI_UNSIGNED_1_BYTE,
		.elem_len       = 1,
		.elem_size      = sizeof(u8),
		...
		.tlv_type       = 0,
		.offset         = offsetof(struct
					   mlo_chip_type_info_s_v01,
					   chip_id),
	},
	{
		.data_type      = QMI_SIGNED_4_BYTE_ENUM,
		.elem_len       = 1,
		.elem_size      = sizeof(enum wlfw_mlo_chip_type_v01),
		.array_type       = NO_ARRAY,
		.tlv_type       = 0,
		.offset         = offsetof(struct
					   mlo_chip_type_info_s_v01,
...
static struct qmi_elem_info wlfw_pmu_param_ext_v01_ei[] = {
	{
		.data_type      = QMI_UNSIGNED_1_BYTE,
		.elem_len       = QMI_WLFW_PMU_PIN_NAME_MAX_LEN_V01,
		.elem_size      = sizeof(u8),
...
static struct qmi_elem_info wlfw_pmu_cfg_ext_v01_ei[] = {
	{
		.data_type      = QMI_DATA_LEN,
		.elem_len       = 1,
		.elem_size      = sizeof(u8),
	...
	},
	{
		...
		.offset         = offsetof(struct
					   wlfw_pmu_cfg_ext_v01,
					   pmu_param_ext),
		.ei_array      = wlfw_pmu_param_ext_v01_ei,
	},
	{
		.data_type      = QMI_EOTI,
		.array_type       = NO_ARRAY,
...
static struct qmi_elem_info wlfw_gpio_config_v01_ei[] = {
	{
		.data_type      = QMI_UNSIGNED_4_BYTE,
		.elem_len       = 1,
		.elem_size      = sizeof(u32),
...
static struct qmi_elem_info wlfw_ddr_file_mem_info_s_v01_ei[] = {
	{
		.data_type      = QMI_SIGNED_4_BYTE_ENUM,
		.elem_len       = 1,
		.elem_size      = sizeof(enum wlfw_ddr_file_type_enum_v01),
		.array_type       = NO_ARRAY,
		.tlv_type       = 0,
		.offset         = offsetof(struct
					   wlfw_ddr_file_mem_info_s_v01,
					   type),
	},
	{
		.data_type      = QMI_UNSIGNED_8_BYTE,
...
static struct qmi_elem_info wlfw_mem_seg_info_s_v01_ei[] = {
	{
		.data_type      = QMI_UNSIGNED_8_BYTE,
		.elem_len       = 1,
		.elem_size      = sizeof(u64),
...
struct qmi_elem_info wlfw_wlan_cfg_req_msg_v01_ei[] = {
	...
	{
		.data_type      = QMI_STRUCT,
		.elem_len       = QMI_WLFW_MAX_EXT_NUM_CE_V01,
		.elem_size      = sizeof(struct wlfw_ce_tgt_pipe_cfg_s_v01),
		.array_type       = VAR_LEN_ARRAY,
		.tlv_type       = 0x1A,
		.offset         = offsetof(struct
	...
	{
		.data_type      = QMI_STRUCT,
		.elem_len       = QMI_WLFW_MAX_EXT_NUM_SVC_V01,
		.elem_size      = sizeof(struct wlfw_ce_svc_pipe_cfg_s_v01),
		.array_type       = VAR_LEN_ARRAY,
		.tlv_type       = 0x1B,
		.offset         = offsetof(struct
...
struct qmi_elem_info wlfw_cap_resp_msg_v01_ei[] = {
	...
	},
	{
		...
		.offset         = offsetof(struct
					   wlfw_cap_resp_msg_v01,
					   ddr_file_download_support_valid),
	},
	{
		.data_type      = QMI_UNSIGNED_1_BYTE,
		.elem_len       = 1,
	...
	},
	{
		...
		.offset         = offsetof(struct
					   wlfw_cap_resp_msg_v01,
					   ddr_file_download_bitmap_valid),
	},
	{
		.data_type      = QMI_UNSIGNED_4_BYTE,
		.elem_len       = 1,
...
struct qmi_elem_info wlfw_host_cap_req_msg_v01_ei[] = {
	...
	{
		.data_type      = QMI_STRUCT,
		.elem_len       = QMI_WLFW_TOTAL_GPIO_CONFIG_V01,
		.elem_size      = sizeof(struct wlfw_gpio_config_v01),
		.array_type       = VAR_LEN_ARRAY,
		.tlv_type       = 0x31,
		.offset         = offsetof(struct
					   wlfw_host_cap_req_msg_v01,
					   gpio_config),
		.ei_array      = wlfw_gpio_config_v01_ei,
	},
	{
		.data_type      = QMI_OPT_FLAG,
		.elem_len       = 1,
	...
	},
	{
		.data_type      = QMI_SIGNED_4_BYTE_ENUM,
		.elem_len       = 1,
		.elem_size      = sizeof(enum wlfw_target_attachment_v01),
		.array_type       = NO_ARRAY,
		.tlv_type       = 0x32,
		.offset         = offsetof(struct
					   wlfw_host_cap_req_msg_v01,
	...
	},
	{
		...
		.offset         = offsetof(struct
					   wlfw_host_cap_req_msg_v01,
					   mlo_chip_type_info_valid),
	},
	{
		.data_type      = QMI_STRUCT,
		.elem_len       = QMI_WLFW_MLO_V2_CHP_V01,
		.elem_size      = sizeof(struct mlo_chip_type_info_s_v01),
		.array_type       = STATIC_ARRAY,
		.tlv_type       = 0x36,
		.offset         = offsetof(struct
					   wlfw_host_cap_req_msg_v01,
					   mlo_chip_type_info),
		.ei_array      = mlo_chip_type_info_s_v01_ei,
	},
	{
		.data_type      = QMI_EOTI,
		.array_type       = NO_ARRAY,
...
struct qmi_elem_info wlfw_misc_req_msg_v01_ei[] = {
	{
		.data_type      = QMI_SIGNED_4_BYTE_ENUM,
		.elem_len       = 1,
		.elem_size      = sizeof(enum wlfw_misc_req_enum_v01),
		.array_type       = NO_ARRAY,
		.tlv_type       = 0x01,
		.offset         = offsetof(struct
					   wlfw_misc_req_msg_v01,
					   type),
	},
	{
		.data_type      = QMI_EOTI,
...
EXPORT_SYMBOL(wlfw_misc_req_msg_v01_ei);

struct qmi_elem_info wlfw_misc_resp_msg_v01_ei[] = {
	{
		.data_type      = QMI_STRUCT,
		.elem_len       = 1,
		.elem_size      = sizeof(struct qmi_response_type_v01),
...
struct qmi_elem_info wlfw_ddr_file_download_req_msg_v01_ei[] = {
	{
		.data_type      = QMI_DATA_LEN,
		.elem_len       = 1,
		.elem_size      = sizeof(u8),
		...
		.tlv_type       = 0x01,
		.offset         = offsetof(struct
					   wlfw_ddr_file_download_req_msg_v01,
					   file_mem_info_len),
	},
	{
		.data_type      = QMI_STRUCT,
		.elem_len       = QMI_WLFW_MAX_NUM_DDR_FILE_DOWNLOAD_V01,
		.elem_size      = sizeof(struct wlfw_ddr_file_mem_info_s_v01),
		.array_type       = VAR_LEN_ARRAY,
		.tlv_type       = 0x01,
		.offset         = offsetof(struct
					   wlfw_ddr_file_download_req_msg_v01,
					   file_mem_info),
		.ei_array      = wlfw_ddr_file_mem_info_s_v01_ei,
	},
	{
		.data_type      = QMI_EOTI,
		.array_type       = NO_ARRAY,
...
EXPORT_SYMBOL(wlfw_ddr_file_download_req_msg_v01_ei);

struct qmi_elem_info wlfw_ddr_file_download_resp_msg_v01_ei[] = {
	{
		.data_type      = QMI_STRUCT,
		.elem_len       = 1,
		.elem_size      = sizeof(struct qmi_response_type_v01),
		...
		.tlv_type       = 0x02,
		.offset         = offsetof(struct
					   wlfw_ddr_file_download_resp_msg_v01,
					   resp),
		.ei_array      = qmi_response_type_v01_ei,
	},
	{
...
EXPORT_SYMBOL(wlfw_ddr_file_download_resp_msg_v01_ei);

struct qmi_elem_info wlfw_partner_chip_state_info_req_msg_v01_ei[] = {
	{
		.data_type      = QMI_OPT_FLAG,
		.elem_len       = 1,
		.elem_size      = sizeof(u8),
		...
		.tlv_type       = 0x10,
		.offset         = offsetof(struct
					   wlfw_partner_chip_state_info_req_msg_v01,
...
EXPORT_SYMBOL(wlfw_partner_chip_state_info_req_msg_v01_ei);

struct qmi_elem_info wlfw_partner_chip_state_info_resp_msg_v01_ei[] = {
	{
		.data_type      = QMI_STRUCT,
		.elem_len       = 1,
		.elem_size      = sizeof(struct qmi_response_type_v01),
		...
		.tlv_type       = 0x02,
		.offset         = offsetof(struct
					   wlfw_partner_chip_state_info_resp_msg_v01,
					   resp),
		.ei_array      = qmi_response_type_v01_ei,
	},
	{
...
EXPORT_SYMBOL(wlfw_partner_chip_state_info_resp_msg_v01_ei);

struct qmi_elem_info wlfw_ddr_dump_upload_done_req_msg_v01_ei[] = {
	{
		.data_type      = QMI_UNSIGNED_4_BYTE,
		.elem_len       = 1,
		.elem_size      = sizeof(u32),
		...
		.tlv_type       = 0x01,
		.offset         = offsetof(struct
					   wlfw_ddr_dump_upload_done_req_msg_v01,
					   status),
	},
	{
		.data_type      = QMI_EOTI,
...
EXPORT_SYMBOL(wlfw_ddr_dump_upload_done_req_msg_v01_ei);

struct qmi_elem_info wlfw_ddr_dump_upload_done_resp_msg_v01_ei[] = {
	{
		.data_type      = QMI_STRUCT,
		.elem_len       = 1,
		.elem_size      = sizeof(struct qmi_response_type_v01),
		...
		.tlv_type       = 0x02,
		.offset         = offsetof(struct
					   wlfw_ddr_dump_upload_done_resp_msg_v01,
					   resp),
		.ei_array      = qmi_response_type_v01_ei,
	},
	{
...
EXPORT_SYMBOL(wlfw_ddr_dump_upload_done_resp_msg_v01_ei);

struct qmi_elem_info wlfw_dummy_wake_req_msg_v01_ei[] = {
	{
		.data_type      = QMI_EOTI,
		.array_type       = NO_ARRAY,
		.tlv_type       = QMI_COMMON_TLV_TYPE,
...
EXPORT_SYMBOL(wlfw_dummy_wake_req_msg_v01_ei);

struct qmi_elem_info wlfw_dummy_wake_resp_msg_v01_ei[] = {
	{
		.data_type      = QMI_STRUCT,
		.elem_len       = 1,
		.elem_size      = sizeof(struct qmi_response_type_v01),
...
EXPORT_SYMBOL(wlfw_dummy_wake_resp_msg_v01_ei);

struct qmi_elem_info wlfw_request_mem_free_ind_msg_v01_ei[] = {
	{
		.data_type      = QMI_STRUCT,
		.elem_len       = 1,
		.elem_size      = sizeof(struct wlfw_mem_seg_info_s_v01),
		.array_type       = NO_ARRAY,
		.tlv_type       = 0x01,
		.offset         = offsetof(struct
					   wlfw_request_mem_free_ind_msg_v01,
					   mem_seg),
		.ei_array      = wlfw_mem_seg_info_s_v01_ei,
	},
	{
		.data_type      = QMI_EOTI,
		.array_type       = NO_ARRAY,
...
EXPORT_SYMBOL(wlfw_request_mem_free_ind_msg_v01_ei);
