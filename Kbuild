...
ifeq ($(CONFIG_CNSS2_DISABLE_SSR_RAMDUMP), y)
KBUILD_CPPFLAGS += -DCONFIG_CNSS2_DISABLE_SSR_RAMDUMP
endif
...
ifeq ($(CONFIG_QLI),y)
KBUILD_CPPFLAGS += -DCONFIG_QLI
endif

ifeq ($(CONFIG_CNSS_SHUTDOWN_CALLBACK),y)
KBUILD_CPPFLAGS += -DCONFIG_CNSS_SHUTDOWN_CALLBACK
endif

ifeq ($(CONFIG_CNSS_IO_COHERENCY),y)
KBUILD_CPPFLAGS += -DCONFIG_CNSS_IO_COHERENCY
endif

ifdef CONFIG_CNSS_QUIRKS_DEFAULT
KBUILD_CPPFLAGS += -DCONFIG_CNSS_QUIRKS_DEFAULT=$(CONFIG_CNSS_QUIRKS_DEFAULT)
endif
